...
2. Count number of time SNP ID was observed, assuming the third column contain the SNP ID (`seen[$3]++`). If this is the first time seeing this SNP ID, print it. 3. Compresses and writes the results to **Height.nodup.gz**
